...
export default function PlatformPage() {
    return (
        <div className="flex flex-col min-h-screen w-full relative overflow-hidden pt-24">
            ...
            <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-blue-500/10 blur-[120px] rounded-full pointer-events-none" />
            ...
            <section className="relative py-24 lg:py-40 px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center min-h-[60vh] justify-center w-full">
                <ParallaxBackground imageUrl="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2672&auto=format&fit=crop" className="opacity-50" overlayClassName="bg-gradient-to-b from-slate-800/80 via-slate-800/90 to-slate-800 pointer-events-none" />
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center text-center">
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white max-w-4xl mb-6">
                            <span className="inline-flex items-center flex-wrap justify-center gap-x-3">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Brain</span>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 w-full">
                <ScrollReveal delay={0.1}>
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">What the Platform Does</h2>
                </ScrollReveal>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {[
                        ...
                        <ScrollReveal key={i} delay={0.1 * i} direction="up">
                            <Card className="bg-slate-800/40 hover:bg-slate-800 border-white/5 hover:border-cyan-500/30 transition-all duration-300 hover:shadow-[0_10px_30px_rgba(6,182,212,0.1)] group h-full">
                                <CardHeader>
                                    <div className="p-3 bg-blue-500/10 w-max rounded-xl mb-4 group-hover:bg-cyan-500/20 group-hover:scale-110 transition-all duration-300">
                                        <feature.icon className="h-6 w-6 text-cyan-400" />
                                    </div>
                                    <CardTitle className="text-xl group-hover:text-cyan-400 transition-colors">{feature.title}</CardTitle>
            ...
            {/* How Agents Work */}
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 w-full bg-slate-800/50">
                <ScrollReveal delay={0.1}>
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-16 text-center">How Agents Work</h2>
                </ScrollReveal>
                    ...
                    {[
                        ...
                        <ScrollReveal key={i} delay={0.1 * i} direction="up">
                            <div className="flex flex-col relative text-center items-center group">
                                <div className="w-16 h-16 rounded-2xl bg-slate-800 border border-cyan-500/30 flex items-center justify-center mb-6 text-cyan-400 shadow-[0_0_15px_rgba(6,182,212,0.15)] relative z-10 group-hover:scale-110 group-hover:border-cyan-400 group-hover:shadow-[0_0_25px_rgba(6,182,212,0.4)] transition-all duration-300">
                                    <item.icon className="h-8 w-8" />
                                </div>
                                <h4 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors">{item.step}</h4>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 w-full">
                <ScrollReveal delay={0.1}>
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">Integrates With Your Stack</h2>
                </ScrollReveal>
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors duration-300">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {group.tools.map(tool => (
                                        <span key={tool} className="text-xs px-3 py-1 bg-black/50 border border-white/5 rounded-full text-gray-300 hover:text-white hover:border-cyan-500/50 transition-colors cursor-default">
                                            {tool}
                                        </span>
                                    ))}
                                </div>
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
                <ScrollReveal delay={0.2} direction="up">
                    <Card className="bg-gradient-to-br from-slate-800 to-slate-800 border-cyan-500/30 overflow-hidden relative shadow-[0_0_40px_rgba(6,182,212,0.1)] hover:shadow-[0_0_60px_rgba(6,182,212,0.2)] transition-shadow duration-500">
            ...
            {/* Footer CTA */}
            <section className="py-24 px-4 sm:px-6 lg:px-8 text-center bg-gradient-to-b from-transparent to-cyan-500/5">
                <ScrollReveal delay={0.1}>
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Ready to build your AI team?</h2>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Button size="lg" className="transition-transform hover:scale-105">Start Free Trial</Button>
