...
import { Terminal, BrainCircuit, Activity, CheckCircle2, Play, Search, Link2, Settings } from "lucide-react";
            ...
            <ScrollReveal delay={0.1}>
                <section className="relative py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto flex flex-col items-center text-center z-10">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white mb-6">
                        Agentic AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Playground</span>
                    </h1>
            ...
            <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <Card className="bg-slate-800/60 border-white/10 backdrop-blur-md shadow-2xl h-full">
                            <CardContent className="p-6 md:p-8 space-y-6">
                                <div>
                                    <h3 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
                                        <Settings className="w-5 h-5 text-cyan-400" /> Task Configurator
                                    </h3>
                                ...
                                <div className="pt-6 border-t border-white/10">
                                    {!isRunning && currentStepIndex === -1 ? (
                                        <Button onClick={runSimulation} size="lg" className="w-full h-14 font-bold shadow-[0_0_20px_rgba(6,182,212,0.3)] bg-cyan-600 hover:bg-cyan-500">
                    ...
                    <div className="lg:col-span-8">
                        <Card className="bg-black border-white/10 shadow-2xl h-[550px] flex flex-col overflow-hidden relative group">
                            {/* Terminal Header */}
                            <div className="h-12 border-b border-white/10 bg-slate-800/50 flex items-center px-4 justify-between shrink-0">
                                ...
                                {currentStepIndex === -1 && !isRunning ? (
                                    ...
                                    <div className="space-y-4">
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            <div className="text-gray-300">
                                                                [{new Date().toLocaleTimeString()}] <span className="text-blue-400 font-bold">[{step.tool}]</span>
                                                            </div>
                                        ...
                                        {isRunning && currentStepIndex < simulationSteps.length - 1 && (
                                            <div className="flex items-center gap-2 text-cyan-500 mt-6 font-bold animate-pulse">
                                                <div className="w-2 h-4 bg-cyan-500" /> Processing...
                                            </div>
                                        )}
                                        ...
                                        {!isRunning && currentStepIndex === simulationSteps.length - 1 && (
                                            <motion.div
                                                initial={{ opacity: 0 }}
                                                animate={{ opacity: 1 }}
                                                className="mt-8 p-4 border border-emerald-500/30 bg-emerald-500/10 rounded-lg text-emerald-400 font-bold flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                                            >
                                                <span>Mission Accomplished. Agent returning to standby mode.</span>
                                                <Button size="sm" className="bg-emerald-600 hover:bg-emerald-500 text-white font-sans font-bold">
                                                    View Execution Log
                                                </Button>
                                            </motion.div>
                                        )}
